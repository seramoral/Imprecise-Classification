...
/*
 *    ChiSquaredProbabilityAttributeEval.java
 ...
 * 
 * <!-- globalinfo-start -->
 * ChiSquaredProbabilityAttributeEval :<br/>
 * <br/>
 ...
 * @see NumericToBinary
 */
public class ChiSquaredProbabilityAttributeEval
   ...
   * Constructor
   */
  public ChiSquaredProbabilityAttributeEval () {
    resetOptions();
  }
  ...
  public void buildEvaluator (Instances data)
    ...
    for (int i = 0; i < data.numAttributes(); i++) {
      if (i != classIndex) {
	m_ChiSquareds[i] = 1-ContingencyTables.chiSquared(ContingencyTables.reduceMatrix(counts[i]), false); 
      }
    }
  }
  ...
  public double evaluateAttribute (int attribute)
    ...
    return 1-m_ChiSquareds[attribute];
  }
  ...
  public static void main (String[] args) {
    runEvaluator(new ChiSquaredProbabilityAttributeEval(), args);
  }
}
