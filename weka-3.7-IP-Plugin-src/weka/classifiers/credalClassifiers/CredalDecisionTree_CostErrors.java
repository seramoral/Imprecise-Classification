...
import weka.core.*;
import java.util.*;
import static weka.classifiers.credalClassifiers.CredalDecisionTree_CostErrors.IMPRECISE_ENTROPY;

/**
 *
 * @author Serafin
 */
public class CredalDecisionTree_CostErrors extends CostSensitiveCredalClassifier implements OptionHandler, AdditionalMeasureProducer{
    ...
    */
    ...
    public String globalInfo() {
        ...
        String output = " Method based on buiding a Credal Decision Tree for Imprecise Classification "
                + " taking into account the cost of errors when classifying new instances"
   ...
   */
    ...
    */
    ...
    public boolean[] computeNonDominatedSet(double[] frequencies) {
        ...
        // Compute lower and upper probabilities
        
        for(int k = 0; k < num_class_values; k++){
            frequency = frequencies[k];
            denominator = num_instances + m_SValue;
            lower_probability = frequency/denominator;
            numerator = frequency + m_SValue;
            upper_probability = numerator/denominator;
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        try {
            System.out.println(Evaluation.evaluateModel(new CredalDecisionTree_CostErrors(), args));
        } catch (Exception e) {
